...
class PDFCreator {
  ...
  Future<void> loadExistingPdf(Uint8List pdfBytes) async {
    _document = sf_pdf.PdfDocument(inputBytes: pdfBytes);
  }
        ...
        case SignType.signature:
          if (element.signatureId != null) {
            final response = await http.get(Uri.parse(
                '${dotenv.env['API_BASE_URL']}/assets/${element.signatureId}'));
