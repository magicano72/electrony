...
class PrimaryColors {
  static final Color mainColor = Color(0xff007cff);
  static final Color secondColor = Color(0xff1b2e35);
  static final Color iconColor = Color(0xff063970);
  ...
  static Color registerColor = fromHex('#2567E8');
  static Color maxUsed = fromHex('#228DD0');
  static Color navyBlue = fromHex('#134D79');
