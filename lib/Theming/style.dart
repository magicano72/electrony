...
class Style {
  ...
  static final TextStyle profile = GoogleFonts.getFont('Scheherazade New',
  ...
  static final TextStyle profileDetail = GoogleFonts.getFont('Montserrat',
      color: Colors.black, fontSize: 18.sp, fontWeight: FontWeight.bold);
  static final TextStyle documentCategory = GoogleFonts.getFont('Inter',
      color: Colors.black, fontSize: 22.sp, fontWeight: FontWeight.bold);
  static final TextStyle documentSubCategory = GoogleFonts.getFont('Inter',
