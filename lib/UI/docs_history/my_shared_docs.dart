...
import 'package:Electrony/UI/pdf_viewer/shared_docs_pdfViewer.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var doc in documents) {
          // // Check if all signers have status 'Submitted'
          // bool allSignersSubmitted =
          //     doc.signers.every((signer) => signer.status == 'Submitted');
          // doc.status = allSignersSubmitted ? 'Submitted' : 'Pending';
