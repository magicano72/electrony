...
class ReceivedDocsPdfviewer extends StatefulWidget {
  final String pdfUrl;
  final String? name;
  final bool? isImage;
  ...
  @override
  _ReceivedDocsPdfviewerState createState() => _ReceivedDocsPdfviewerState();
}

class _ReceivedDocsPdfviewerState extends State<ReceivedDocsPdfviewer> {
                ...
                if (value == 'Submit') {
                  ...
                  if (loginSuccessful) {
                    try {
                      ...
                      // Proceed with signature update if user confirmed
